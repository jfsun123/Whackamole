...
#define StripLights_GAMMA_CORRECTION   1
...
#define StripLights_LED_LAYOUT       1
...
#define StripLights_GRIDMODE_WRAP    0
    ...
    #define StripLights_ROWS         ((30 +  (15 - 1 ))/(15 ) )
    #define StripLights_TOTAL_LEDS   30

    #define StripLights_ARRAY_COLS   (int32)(30 + 15)
    ...
    #define StripLights_COLUMNS      (int32)((2) * (uint32)(16u) )
    #define StripLights_ROWS         (int32)((1) * (uint32)(16u) )
    #define StripLights_TOTAL_LEDS   (StripLights_COLUMNS*StripLights_ROWS)

    #define StripLights_ARRAY_COLS   (int32)(2*(int32)256)
    #define StripLights_ARRAY_ROWS   (int32)(1)
    
    #define StripLights_MIN_X        (int32)0
    #define StripLights_MAX_X        (int32)((2*(int32)16) - (int32)1)
