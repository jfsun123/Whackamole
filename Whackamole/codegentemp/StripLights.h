...
#define StripLights_GRIDMODE_WRAP    0
    ...
    #define StripLights_ROWS         ((14 +  (10 - 1 ))/(10 ) )
    #define StripLights_TOTAL_LEDS   14

    #define StripLights_ARRAY_COLS   (int32)(14 + 10)
