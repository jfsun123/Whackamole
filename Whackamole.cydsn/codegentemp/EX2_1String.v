...
`ifdef WARP
`define CY_BLK_DIR "C:\Users\James Sun\Desktop\FunWithLEDs\WS281xLib.cylib\B_WS2811_v1_3"
`include "C:\Users\James Sun\Desktop\FunWithLEDs\WS281xLib.cylib\B_WS2811_v1_3\B_WS2811_v1_3.v"
`else
`define CY_BLK_DIR "C:\Users\James Sun\Desktop\FunWithLEDs\WS281xLib.cylib\B_WS2811_v1_3"
`include "C:\Users\James Sun\Desktop\FunWithLEDs\WS281xLib.cylib\B_WS2811_v1_3\B_WS2811_v1_3.v"
`endif
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("7220e00d-be6b-4697-8f0d-998c3870b593"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Flex_net;
	wire [0:0] tmpFB_0__Pin_Flex_net;
	wire [0:0] tmpIO_0__Pin_Flex_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Flex_net;
	electrical [0:0] tmpSIOVREF__Pin_Flex_net;

	cy_psoc3_pins_v1_10
		#(.id("75eb8b30-1a8a-4e1b-bd03-501918a421d9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Flex
		 (.oe(tmpOE__Pin_Flex_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Flex_net[0:0]}),
		  .io({tmpIO_0__Pin_Flex_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Flex_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Flex_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Flex_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
